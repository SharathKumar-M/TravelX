...
npm install react @radix-ui/react-slot class-variance-authority
...
const Header = () => {
  ...
  const navLinks = user
    ...
    : [
        { to: '/home/login', label: 'Login', icon: LogIn, lassName: 'text-gray-300 hover:text-white hover:bg-slate-700/70', },
        { to: '/home/register', label: 'Register', icon: UserPlus },
      ];

  return (
    <header className="bg-gradient-to-r from-slate-900 oklch-to-blue-500 via-indigo-500 to-slate-900 text-white shadow-lg border-b border-slate-700">
